document.addEventListener('DOMContentLoaded', () => {
    ...
    const albumsData = [
        ...
        { name: 'Escandalo Íntimo', artist: 'Luísa Sonza', image: './img/album-escandalo.jpg' }
    ];
    ...
    artistsData.forEach( artist => {
        ...
        artistCard.innerHTML = `
             <img src="${artist.image}" alt="imagem do ${artist.name}" class="image-artist">
            <div>
         <h3>${artist.name}</h3>
    ...
    albumsData.forEach( album => {
        ...
        albumCard.innerHTML = `
             <img src="${album.image}" alt="imagem do ${album.name}" class="image-album">
